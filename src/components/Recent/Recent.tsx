...
const data=[
    
    {
        ...
        description:"65% of companies increased their spending on digital and technological initiatives during the past year. The pace of business is chnaging fast. In just 3 months, the pandemic sped up the adoption of digital technologies by three to seven years"

    },
    {
        urlToImage: notification2,
        title:"The Keys to Leading E-Commerce are Personaliztion and AI. Here's Why",
        description:"Customers want personalized digital experiences. Discover how you can use AI solutions to make custom digital 1:1 interactions a reality. Enterprise-size companies must work harder to maintain a strong competitive position. "

    },
    {
        urlToImage: notification3,
        title:"Sprinklr named a leader in The Forrester Wave: Social Suites, Q3 2021 report!",
        description:"Sprinklr is named a Leader in The Forrester Wave: Social Suites Q3 2021 for a second time! According to Forrester's evaluation, Sprinklr leads a formidable and intensely customizable unified platform."
    ...
    return(
        ...
        <div className="notify">
             <div className="option">
              <h4 onClick={handleClick}  id="notification">Notifications</h4>
              <h4 onClick={handleClick} id="announcements">Accouncements</h4>
              </div>
              {notification ? 
