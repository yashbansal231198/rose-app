import profile1 from "../../assets/vansh.jpeg";
...
import useTopProfiles from "../../hooks/useTopProfiles.jsx";
       ...
       <div>
        {
          topProfiles.map((Profile, idx)=> (
            <Row name={Profile.name} location={Profile.location} image={profile1} coin={Profile.coin}/>
          ))
        }
      </div> )
}
