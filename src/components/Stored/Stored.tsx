  ...
  return (
    <div className="info">
      ...
      <div className="accounts">
        ...
        <h5>
          Please "Add" to connect your social accounts to complete your profile
          and earn awards
        </h5>
      </div>
      <div className="language1">
        ...
        <h5>
          Choose your preferred language for headlines, buttons, and other text
          to personalize your experience on this website
        </h5>
